...
{
	//	UKismetSystemLibrary::PrintString(this, "carPawn:" + FString::FromInt(Id) + ":" + FString::SanitizeFloat(Val) + "input:" + FString::SanitizeFloat(InputValue)+":open:"+(InputOpen? "true":"false"));
